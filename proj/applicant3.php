		...
		<div class='navbar-inner'>
         ...
         <div class='span11'><br><br><br><br>
          <table class='table table-striped'><tr><td>
            <form class='form-horizontal' role='form' id='form' method='post' action='editapplicants.php'>
                 
                 <div class='row'>
                         <div class='span5'>
                            
                  <b>FirstName:&nbsp&nbsp&nbsp&nbsp</b><input type='text'  class='form-control' name='firstname' id='firstname' value='$firstname'>      
                        </div>
                        <div class='span5'>
                              <div class='control-group'>       
            <label class='control-label' for='lastname'><b>LastName:&nbsp&nbsp</b></label> 
                               <div class='controls'>             
            <input type='text' class='form-control' name='lastname' id='lastname'  value='$lastname'><br><br>
                               </div>
                              </div> 
                        </div>
                  </div>
               ...
               <div class='row'><br> 
                    ...
                    <div class='span12'>
                     <b>University:&nbsp&nbsp&nbsp&nbsp</b><input type='text' class='input-3large'  name='university' id='university' value='$university'>
                    </div>
               </div>
               <div class='row'><br>
                     <div class='span12'>
                  <b>Campus:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>
                  <input type='text' class='input-xxlarge' name='campus' id='campus' value='$campus' >
                     </div>
               </div>      
                <div class='row'><br>
                       <div class='span5'>
                  <b>Discipline:&nbsp&nbsp&nbsp</b>
                  <input type='text' class='input-large' name='discipline' id='discipline'  value='$discipline' >
                       </div>
                       <div class='span4'>
                       ID:<input type='text' id='id' name='id' value ='$id'> 
                       </div>
                       <div class='span3'>
                  <b>CGPA:&nbsp</b></a><input type='text' class='input-small' name='cgpa' id='cg'  value = '$cgpa'>   
                       </div>
               </div>
                <div class='row'><br>
                     <div class='span12'>
               ...
               <div class='row'><br>
                     <div class='span12'>
                  <b>PassportNo:</b>
                  <input type='text' class='input-xlarge' name='passport' id='passport'  value ='$passport' >
                     </div>
               </div>      
               <div class='row'><br>
                          <div class='span6'>
                  <b>Address:&nbsp&nbsp<br></b>
                  <textarea type='text'  class='input-xlarge' name='address' id='address'  >$address</textarea>
                          </div>
                          <div class='span5'>
                  <b>Permanent Address:&nbsp&nbsp<br></b>
                  <textarea type='text'  class='input-xlarge' name='permanent' id='paddress' >$permanent</textarea>
                          </div>
               </div>      
               <div class='row'><br>
                     <div class='span12'>
                  <b>ContactNo:&nbsp</b>
                  <input type='text' class='input-large' name='contact' id='contact' value ='$contact' >
                     </div>
               </div> 
              <div class='row'><br><br>
                     <div class='span1'>
