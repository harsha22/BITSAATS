          ...
          <table class='table table-striped'><tr><td>
            <form class='form-horizontal' role='form' id='form' method='post' action='applicants.php'>
                 ...
                 <div class='row'>
                  ...
                  <b>FirstName:&nbsp&nbsp&nbsp&nbsp</b><input type='text'  class='form-control' name='firstname' id='firstname' placeholder='$firstname' value='$firstname'>      
                        </div>
                        <div class='span5'>
                              <div class='control-group'>       
            <label class='control-label' for='lastname'><b>LastName:&nbsp&nbsp</b></label> 
                               <div class='controls'>             
            <input type='text' class='form-control' name='lastname' id='lastname' value='$lastname' placeholder='$lastname'><br><br>
                               </div>
                              </div> 
                        </div>
                  </div>
                ...
                <div class='row'>
                    ...
                    <div class='span12'>
                   <b>DateOfBirth:&nbsp</b><input type='text' name='dob' id='date' value='$dob' placeholder='$dob'>
                    </div> 
               </div>
               <div class='row'><br> 
                    <div class='span1'>
                    ...
                    <div class='span12'>
                     <b>University:&nbsp&nbsp&nbsp&nbsp</b><input type='text' class='input-3large' value='$university' name='university' id='university' placeholder='$university'>
                    </div>
               </div>
               <div class='row'><br>
                     <div class='span12'>
                  <b>Campus:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>
                  <input type='text' class='input-xxlarge' name='campus' id='campus' value='$campus' placeholder='$campus' >
                     </div>
               </div>      
                <div class='row'><br>
                       <div class='span5'>
                  <b>Discipline:&nbsp&nbsp&nbsp</b>
                  <input type='text' class='input-large' name='discipline' id='discipline' value='$discipline' placeholder='$discipline' >
                       </div>
                       <div class='span4'>
                       ID:<input type='text' id='id' value='$id' placeholder='$id'> 
                       </div>
                       <div class='span3'>
                  <b>CGPA:&nbsp</b></a><input type='text' class='input-small' name='cgpa' id='cg' value='$cgpa' placeholder='$cgpa'>   
                       </div>
               </div>
                <div class='row'><br>
                     <div class='span12'>
               ...
               <div class='row'><br>
                     <div class='span12'>
                  <b>PassportNo:</b>
                  <input type='text' class='input-xlarge' name='passport' id='passport' value='$passport' placeholder='$passport' >
                     </div>
               </div>      
               <div class='row'><br>
                          <div class='span6'>
                  <b>Address:&nbsp&nbsp<br></b>
                  <textarea type='text'  class='input-xlarge' name='address' id='address' value='$address' placeholder='$address' ></textarea>
                          </div>
                          <div class='span5'>
                  <b>Permanent Address:&nbsp&nbsp<br></b>
                  <textarea type='text'  class='input-xlarge' name='permanent' id='paddress' value='$permanent' placeholder='$permanent' ></textarea>
                          </div>
               </div>      
               <div class='row'><br>
                     <div class='span12'>
                  <b>ContactNo:&nbsp</b>
                  <input type='text' class='input-large' name='contact' id='contact' value='$contact' placeholder='$contact' >
                     </div>
               </div> 
              <div class='row'><br><br>
                     <div class='span1'>
