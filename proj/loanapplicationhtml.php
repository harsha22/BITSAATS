                ...
                <form class='form-horizontal' role='form' id='form' method='post' action='travelapplication.php'>
                  ...
                  <h5>At the time of travel,If you are in receit of any other Scholarship then please provide details</h5>
                    ...
                    <tr><td>
                     ...
                     <h4>Proof Of Repayment:</h4><br>
                     <table class='table table-bordered'>
                     <tr><td>
                        <h5> 
                         Please attach any document (e-mail, link to the mention of reimbursement, etc.) that can act as a proof of repayment of the loan offered by BITSAA
                        </h5>     
                     </td></tr>
                    </table> 
...
I declare that the information supplied by me on this form is complete and correct in every particular. I understand that BITSAA reserves the right to vary or reverse any decision made on the basis of incomplete or incorrect information.</h5><br><br>
                    ...
                    <table class='table table-bordered'>
                     <tr><td>
                       <ul>
                      <li><h5> The BITSAA Loan aims to provide assistance only for the travel expenses associated with the event. This does not include registration costs, medical insurance or any other expense incurred during the trip. 
The applicant has to submit the completed application form within 15 days after the first communication from BITSAA to be considered for evaluation by the panel for 0% loan offer.</h5></li>

                      <li><h5>   The maximum financial assistance provided by the BITSAA Loan is up to a maximum of $ 500 (not exceeding Rs. 25,000 INR) per loan.  But this can be altered depending on availability of funds with BITSAA.
                      </h5></li> 
                      <li><h5>The interest rate charged on the loan amount will be 0.00% (making it a 'bridge loan/scholarship'). </h5></li>
                       <li><h5>The loan recipient needs to return the entire amount within 3 years of obtaining the loan so that other BITS students can avail of the same opportunity.  </h5></li>
                       <li><h5>The first installment of such return will be decided by the recipient, provided it starts within the first 24 months of obtaining the loan.  It can be paid back to BITSAA International in monthly installments or in lump sum, as determined by the loan recipient.</h5></li>
                       <li><h5>In extreme hardship cases (to be determined by BITSAA International on an individual case by case basis), the recipient can defer the return for another 12 months with prior permission from the BITSAA International authority.</h5></li>
                       <li><h5>In case of reimbursement of part or full of the expenses by host organization, the student must repay the amount reimbursed within two weeks after reimbursement.</h5></li>
                      <li><h5>In case of death the entire amount will be waived.</h5></li>
                       <li><h5>In the case of the recipient finding other sources to fund his/her travel, he/she must provide details about them, and the failure to do so may result in the cancellation of the loan.</h5></li>
                       <li><h5>Loan applications are accepted year round, but must be received by the Selection Committee as early as possible and ideally, 60 days prior to the beginning of the travel. </h5></li>
                       <li><h5>The recipient of the loan should submit scanned copy of all the travel receipts and a detailed report of his trip to the Selection Committee within 2 weeks from the day of return, failing which BITSAA has the right to withhold part/whole of the scholarship award.</h5></li>
                       <li><h5>The loan recipient is entirely responsible to follow up with the host organization for reimbursement and keep BITSAA informed of the same.</h5></li>
