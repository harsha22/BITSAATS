   ...
   echo "please enter password\n";
	...
	<body>
		...
		<div class='navbar-inner'>
		   ...
		   <li><a href='logout.php'>&nbsp&nbsp&nbsp&nbspLogout</a></li>
        	   </ul>
          </div>
         </div>
         </div>
         ...
         <div class='span11'><br><br><br><br>
          <table class='table table-striped'><tr><td>
                   ...
                   <div id='change-date' >    
                    <b>DateOfBirth:&nbsp</b>
                      <div class='input-append datepicker date' id='dp3' data-date='2013-09-25' data-date-format='yyyy-mm-dd'> 
                            <input size='16' type='text' class='date' name='dob' id='date' placeholder='$dob'>
           ...
           <form method='post' action='applicant3.php'>
             <div class='row'> 
               <div class='span1'>
                </div>
               <div class='span2'>   
